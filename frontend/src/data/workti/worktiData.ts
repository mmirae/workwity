    ...
    options: [
      {
        ...
        text: "Jay, 이번 쿼터 KPI 얼라인을 위해 이 액션 아이템을 ASAP하게 린하게 가시죠!",
      },
      {
        label: "B",
        badgeTag: "#직관적표준어_선호",
        displayText: "직관적이고 명확한 한국어",
        text: "제이 님, 이번 분기 목표 달성을 위해 이 실행 과제를 가능한 한 빨리 간결하게 진행하시죠!",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        text: "루카스, 이번 기획안 확인해 봤어? 의견 공유해 줘!",
      },
      {
        label: "B",
        badgeTag: "#상호존댓말_선호",
        displayText: "~님 호칭 & 상호 존댓말",
        text: "김철수 님, 이번 기획안 확인해 보셨나요? 의견 부탁드립니다!",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        text: "이 부분은 논리가 부족합니다. 핵심 수치 위주로 기획안 전면 수정 부탁드립니다.",
      },
      {
        label: "B",
        badgeTag: "#쿠션어_공감형",
        displayText: "배려와 공감 중심 쿠션어",
        text: "고생 많으셨어요! 전체적으로 좋은데, 수치 부분만 조금 더 보완되면 더 완벽할 것 같아요.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        text: "오늘 회의는 15분! 결론만 빠르게 정하고 바로 실행으로 넘어가시죠.",
      },
      {
        label: "B",
        badgeTag: "#충분한논의_회의",
        displayText: "다양한 의견을 나누는 논의형 회의",
        text: "시간이 걸리더라도 관련된 분들 의견을 충분히 들어보고 합의된 결론을 내리시죠.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        text: "메시지 보내면 바로바로 답장하고, 급한 건은 전화나 DM으로 확인하는 게 편해요.",
      },
      {
        label: "B",
        badgeTag: "#비동기소통_선호",
        displayText: "여유 있게 확인하고 답장해요",
        text: "급한 게 아니면 서로의 몰입 시간을 방해하지 않게, 확인 후 여유 있게 답장하는 게 편해요.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        text: "문서보다 직접 얼굴 보고 얘기하면서 궁금한 점을 바로 물어보고 이해하는 게 빨라요.",
      },
      {
        label: "B",
        badgeTag: "#문서화_선호",
        displayText: "문서로 꼼꼼히 남기는 게 편해요",
        text: "나중에 누가 봐도 이해할 수 있도록 맥락과 결정 이유까지 문서로 정리해두는 게 편해요.",
      },
    ],
  },
